...
export default function PrivacyPage() {
  return <SiteInfoPage eyebrow="PRIVACY" title="개인정보처리방침" description="PLAB Check는 서비스 운영에 필요한 최소한의 정보만 처리합니다.">
    ...
    <h2>3. 이용 목적과 보관</h2>
    <p>저장 정보는 게시글·댓글 제공, 작성자 본인의 삭제 확인, 서비스 보안과 운영을 위해 사용합니다. 신청자 명단 조회 횟수는 개인 식별 정보 없이 오늘 집계와 누적 집계로만 저장합니다. 삭제된 게시글과 댓글은 서비스 화면에서 제거되며, 법령이나 보안상 필요한 로그는 호스팅 제공자의 정책에 따라 보관될 수 있습니다.</p>
    <h2>4. 외부 서비스</h2>
